...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.print("Please enter the habitat number you would like to view (or 'exit' to quit): ");
            ...
            try {
                ...
                System.out.println("Invalid input. Please enter a valid habitat number or 'exit'.");
            }
        }
    }
}